...
urlpatterns = [
    ...
    re_path(r'^purchases/$',views.PurchaseList.as_view()),
    re_path(r'^purchases_search/$', views.PurchaseListSearch.as_view()),
    re_path(r'^users/$',views.UserList.as_view(),name='user-list'),
    re_path(r'^user/(?P<pk>[0-9]+)/$',views.UserDetail.as_view(),name='user-detail'),
 #   re_path(r'^purchases/$', views.PurchaseList2.as_view()),
